...
class Purchased_order extends MY_Controller {
    ...
    function __construct(){
        ...
        $this->load->model('purchased_order_model', 'po_model');
    ...
    public function index()
    {
        ...
        $this->load->view('purchased_order/index');
    ...
    public function getPurchasedOrder(){
        ...
        $groups = $this->po_model->getLimitOrder($page);
    ...
    public function addOrder($pr_id = null, $id=null)
    {
        $data['pr_id'] = $pr_id;
        ...
        $this->load->view('purchased_order/modal/add', $data);
    }
...
//        pre_print($items);
        ...
        $this->load->view('purchased_order/modal/pr_items', $data);
    }
