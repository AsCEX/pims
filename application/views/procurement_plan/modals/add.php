        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="textarea" placeholder="Description text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
                ...
                <div class="form-group col-md-5">
                    ...
                    <input class="form-control input-lg text-right" name="budget" type="text" placeholder="0.0" />
                </div>
