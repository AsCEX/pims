                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="grid panel panel-default" id="grid_pr">
                                            <div class="panel-heading">Purchased Orders</div>
                                            <div class="panel-body">
                                                <a href="<?php echo site_url('purchased_order/addOrder/'); ?>" class="btn btn-primary display-modal" title="Add New Purchased Request">Add New</a>
                                                <br /><br />
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                                                    ...
                                                    <tr class="init-row">
                                                        ...
                                                        <td><span class="po_code_id"></span></td>
                                                        <td><span class="s_business_name"></span> - <span class="s_first_name"></span> <span class="s_middle_name"></span> <span class="s_last_name"></span> <span class="s_ext_name"></span></td>
                                                        <td><span class="ofc_name"></span></td>
                                                        <td><span class="po_created_date"></span></td>
                                                        <td>
                                                            <div class="quicklinks pull-right"><a href="<?php echo site_url('purchased_order/addOrder'); ?>/" class="pr_id display-modal" title="Edit Record"><i class="fa fa-pencil"></i></a></div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <input type="hidden" name="grid_url" value="<?php echo site_url('purchased_order/getPurchasedOrder'); ?>" />
