                ...
                <div class="box">
                    ...
                    <div class="grid panel panel-default" id="grid_users">
                        <div class="panel-body">
                            <a href="<?php echo site_url('offices/addOffice/'); ?>" class="btn btn-primary display-modal" title="Add New Group">Add New</a>
                            <br /><br />
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                                ...
                                <tr class="init-row">
                                    <td>
                                        <span class="ofc_id"></span>
                                    </td>
                                    <td><span class="ofc_code"></span></td>
                                    <td><span class="ofc_initial"></span></td>
                                    <td><span class="ofc_name"></span></td>
                                    <td>
                                        <div class="quicklinks pull-right"><a href="<?php echo site_url('offices/addOffice'); ?>/" class="ofc_id display-modal" title="Edit Record"><i class="fa fa-pencil"></i></a></div>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <input type="hidden" name="grid_url" value="<?php echo site_url('offices/getOffices'); ?>" />
